...
auto fast = [](const sdds::Vehicle* src) {

	if (src->topSpeed() > 300.00) {
...
auto broken = [](const sdds::Vehicle* src) {

	if (src->condition() == "broken") {
