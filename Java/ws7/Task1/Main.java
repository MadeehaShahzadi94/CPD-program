...
{
    private final Label country = new Label("Country Name:");
    ...
    public void start(Stage primaryStage)
    {
        ...
        states.getChildren().addAll(country,txtState);

        main.getChildren().addAll(states,answer,find);
        ...
        find.setOnAction(e -> 
        {
            ...
            {
            	answer.setText("The capital of " + query + " is " + capitals.get(query.toUpperCase()));
            }
            else if(query.isEmpty()) 
            {
            	answer.setText("Please enter a state.");
            }
            else 
            {
            	answer.setText("State not found.");
            }
        });
